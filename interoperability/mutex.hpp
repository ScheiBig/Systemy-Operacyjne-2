...
inline i_op::basic_mutex::basic_mutex() {}

inline i_op::mux_result i_op::basic_mutex::lock() noexcept(false)
{
#ifdef OS_WIN32
...
inline i_op::mux_result i_op::basic_mutex::lock(i_op::time_unit const& _duration) noexcept(false)
{
#ifdef OS_WIN32
...
inline i_op::mux_result i_op::basic_mutex::try_lock() noexcept(false)
{
#ifdef OS_WIN32
...
inline i_op::mux_result i_op::basic_mutex::try_lock(i_op::time_unit const& _duration) noexcept(false)
{
#ifdef OS_WIN32
    DWORD wait_time{ (DWORD)((((_duration.h * 60) + _duration.min) * 60 + _duration.s * 1000) + _duration.ms) };
    switch (WaitForSingleObject(this->__mux_hdl, wait_time))
...
inline void i_op::basic_mutex::release() noexcept(false)
{
#ifdef OS_WIN32
...
inline void i_op::basic_mutex::close() noexcept(false)
{
#ifdef OS_WIN32
...
inline i_op::mutex::mutex() noexcept(false)
{
#ifdef OS_WIN32
...
inline i_op::named_mutex<_cr_new>::named_mutex(char const* _name) noexcept(false)
{
#ifdef OS_WIN32
...
template<bool _cr_new>
inline i_op::named_mutex<_cr_new>::~named_mutex()
{
    try
    {
        if (
...
template<bool _cr_new>
inline void i_op::named_mutex<_cr_new>::unlink() noexcept(false)
{
#ifdef OS_LINUX
...
template<bool _cr_new>
inline void i_op::named_mutex<_cr_new>::close() noexcept(false)
{
#ifdef OS_LINUX
    int e[3]{ 0 };
